<nav class="bg-gray-800" x-data="{ isOpen: false }">
        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-navlink href="{{ url('/posts') }}" :active="request()->is('posts')">Posts</x-navlink>
                        ...
                        <x-navlink href="{{ url('/menu') }}" :active="request()->is('menu')">Menu</x-navlink>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button @click="isOpen = !isOpen" type="button" aria-controls="mobile-menu" aria-expanded="false"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                        aria-hidden="true" class="hidden size-6" :class="{ 'block': isOpen, 'hidden': !isOpen }">
    ...
    <div id="mobile-menu" class="md:hidden" x-show="isOpen">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-navlink-mobile href="{{ url('/') }}" :active="request()->is('/')">Home</x-navlink-mobile>
            <x-navlink-mobile href="{{ url('/posts') }}" :active="request()->is('posts')">Posts</x-navlink-mobile>
            <x-navlink-mobile href="{{ url('/about') }}" :active="request()->is('about')">About</x-navlink-mobile>
            <x-navlink-mobile href="{{ url('/contact') }}" :active="request()->is('contact')">Contact</x-navlink-mobile>
            <x-navlink-mobile href="{{ url('/menu') }}" :active="request()->is('menu')">Menu</x-navlink-mobile>
        </div>
